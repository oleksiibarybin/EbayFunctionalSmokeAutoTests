...
public class PriceFilterTests extends BaseTest {
    ...
    private static final String PRICE_ZERO_VALUE = "0";
    private static final String MIN_PRICE_VALID_VALUE = "1000";
    private static final String MAX_PRICE_VALID_VALUE = "2000";
    private static final String PRICE_INVALID_NEGATIVE_VALUE = "-1";
    private static final String PRICE_INVALID_CHARACTER_VALUE = "a";
    private static final String EXPECTED_PRICE_INVALID_VALUE_ERROR_MESSAGE = "Please provide a valid price range";
    private static final String EXPECTED_PRICE_ZERO_VALUE_NO_MATCHES_FOUND_MESSAGE = "No exact matches found";
